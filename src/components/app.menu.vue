<template>
  <div>
    <!-- <ul class="flex flex-wrap align-baseline justify-center gap-5">
      <NuxtLink href="/game-tech">Game Tech</NuxtLink>
      <NuxtLink href="/brands">Brands Entering Game</NuxtLink>
      <NuxtLink href="/studio">Studio Introduction</NuxtLink>
      <NuxtLink href="/new-release">New Release</NuxtLink>
      <NuxtLink href="/jobs">Game Job</NuxtLink>
      <NuxtLink href="/startup">Startup</NuxtLink>
      <NuxtLink href="/events">Events</NuxtLink>
      <NuxtLink href="/thoughts">Thoughts</NuxtLink>
    </ul> -->
    <nav class="relative px-4 py-4 flex justify-end items-center bg-white">
      <div class="lg:hidden">
        <button class="navbar-burger flex items-center text-blue-600 p-3" @click="openMobileMenu()">
